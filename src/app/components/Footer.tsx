    ...
    return (
        <footer className="bg-gray-800 text-white p-4">
            <div className="flex justify-center space-x-4 mb-2 my-20">
                <a href="https://github.com/augustoocch" target="_blank" rel="noopener noreferrer">
                    <img src="./images/github.png" alt="GitHub" className="social-icon h-8 w-8 md:h-10 md:w-10" />
                </a>
                <a href="https://www.linkedin.com/in/augusto-occhiuzzi-developer/" target="_blank" rel="noopener noreferrer">
